...
class QuadraticServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SolveQuadratic = channel.unary_unary(
                '/QuadraticService/SolveQuadratic',
...
class QuadraticServiceServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_QuadraticServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'QuadraticService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('QuadraticService', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class QuadraticService(object):
    """Missing associated documentation comment in .proto file."""
